...
class ListNewsAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        try{
            holder.author.setText(song.get(Tab1Fragment.KEY_AUTHOR));
            holder.title.setText(song.get(Tab1Fragment.KEY_TITLE));
            holder.time.setText(song.get(Tab1Fragment.KEY_PUBLISHEDAT));
            holder.sdetails.setText(song.get(Tab1Fragment.KEY_DESCRIPTION));
